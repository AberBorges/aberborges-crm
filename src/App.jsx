              ...
              <div style={{display:"flex",gap:8,flexWrap:"wrap"}}>
                {ab.paredIrregular?(
                  ...
                  <div style={{flex:2,minWidth:80}}>
                    ...
                    <input style={S.dimInput} type="number" step="0.5" value={ab.anchoSup||""} onChange={e=>{setAb(ab.id,"anchoSup",e.target.value);setAb(ab.id,"anchoInf",e.target.value);}} placeholder="0"/>
                  </div>
                )}
