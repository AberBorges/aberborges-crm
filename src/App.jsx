...
function AgendaView({ agenda, clientes, onSave, onBack, onVerCliente, showToast, onUpdateCliente }) {
  ...
  const guardarEdicionVisita = () => {
    const nuevas = agenda.map(v=>v.id===editingVisitaId ? {...v,...editForm} : v);
    onSave(nuevas);
      ...
      {modo==="nueva" && (
        <div style={S.card}>
          ...
          <div style={{marginBottom:14}}>
            ...
            <input style={S.inp} placeholder="Traer metro, confirmar antes..." value={form.nota} onChange={e=>setForm(p=>({...p,nota:e.target.value}))}/>
          </div>
      ...
      {modo==="editarVisita" && (
        <div style={S.card}>
          ...
          <div style={{marginBottom:14}}>
            ...
            <input style={S.inp} placeholder="Nota opcional..." value={editForm.nota} onChange={e=>setEditForm(p=>({...p,nota:e.target.value}))}/>
          </div>
          <div style={{display:"flex",gap:10}}>
