  ...
  return (
    <div style={S.app}>
      ...
      <header style={S.header} className="no-print">
        ...
        <div style={{...S.hRight,gap:4,flexShrink:0}}>
          {view==="lista"&&(
            <button style={{...S.ghostBtn,fontSize:11,padding:"6px 7px"}}
              onClick={()=>setView("agenda")}>📅 Agenda</button>
          )}
          {view==="lista"&&(
            <button style={{...S.ghostBtn,fontSize:11,padding:"6px 7px",borderColor:"#34d39955",color:"#34d399"}}
              onClick={()=>setView("obras")}>📦 Obras</button>
          )}
          {view==="lista"&&(role==="presupuestador"||role==="admin"||role==="deudores")&&(
            <button style={{...S.ghostBtn,fontSize:11,padding:"6px 7px",borderColor:"#f43f5e55",color:"#f43f5e"}}
              onClick={()=>setView("deudores")}>💳 Deu.</button>
          )}
          {view==="lista"&&(role==="vendedor"||role==="admin"||role==="presupuestador")&&(
            <button style={{...S.primaryBtn,background:ACCENT,color:BG,padding:"6px 10px",fontSize:12}} onClick={()=>{
          ...
          <button style={{...S.ghostBtn,fontSize:11,padding:"6px 7px"}} onClick={()=>{setRole(null);setPinRole(null);}}>Salir</button>
        </div>
      </header>
