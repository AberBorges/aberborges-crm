...
const TIPOS = [
  ...
  },
  {
    ...
    configs:[{id:"cat1",label:"Catalana",desc:"Persiana Catalana"}],
  },
];
...
function DetailView({cliente,role,agenda,onSaveAgenda,onUpdate,onDelete,showToast}){
  ...
  // Guarda solo el status directo en Supabase (más confiable)
