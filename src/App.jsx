      ...
      <div style={{display:"flex",gap:10}}>
        ...
        <div style={{flex:1}}>
          ...
          {["mampara_f1","mampara_std"].includes(ab.tipo)?(
            // Mampara: ancho arriba, ancho abajo, alto (paredes pueden no ser rectas)
            <div style={{display:"flex",flexDirection:"column",gap:6,marginBottom:8}}>
              ...
              {ab.anchoSup&&ab.anchoInf&&Math.abs(parseFloat(ab.anchoSup)-parseFloat(ab.anchoInf))>1&&(
                <div style={{fontSize:11,color:"#f59e0b",background:"#f59e0b15",border:"1px solid #f59e0b44",borderRadius:7,padding:"5px 9px"}}>
                  ⚠️ Diferencia de {Math.abs(parseFloat(ab.anchoSup)-parseFloat(ab.anchoInf)).toFixed(1)}cm entre ancho sup e inf — verificar pared
                </div>
              )}
            </div>
          ):(
          ...
          {series.length>0&&(
            <div style={{display:"flex",gap:8,marginBottom:8,flexWrap:"wrap",alignItems:"center"}}>
              ...
              {!["persiana","fijo","celosia","catalana","mampara_f1","mampara_std"].includes(ab.tipo)&&ab.tipo&&(
                <label style={{display:"flex",alignItems:"center",gap:6,cursor:"pointer",fontSize:12,
          ...
          {ab.tipo&&ab.tipo!=="catalana"&&!["mampara_f1","mampara_std"].includes(ab.tipo)&&(
          <div style={{display:"flex",gap:8,flexWrap:"wrap",marginBottom:8}}>
            <div style={{flex:1,minWidth:120}}>
              <label style={S.miniLbl}>Color</label>
