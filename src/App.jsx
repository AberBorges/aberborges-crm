  ...
  return (
    <div style={S.app}>
      ...
      <header style={S.header} className="no-print">
        ...
        <div style={{...S.hRight,gap:4,flexWrap:"wrap",justifyContent:"flex-end"}}>
          {view==="lista"&&(
            <button style={{...S.ghostBtn,fontSize:11,padding:"6px 8px"}}
              onClick={()=>setView("agenda")}>📅</button>
          )}
          {view==="lista"&&(
            <button style={{...S.ghostBtn,fontSize:11,padding:"6px 8px",borderColor:"#34d39955",color:"#34d399"}}
              onClick={()=>setView("obras")}>📦</button>
          )}
          {view==="lista"&&(role==="presupuestador"||role==="admin"||role==="deudores")&&(
            <button style={{...S.ghostBtn,fontSize:11,padding:"6px 8px",borderColor:"#f43f5e55",color:"#f43f5e"}}
              onClick={()=>setView("deudores")}>💳</button>
          )}
          {view==="lista"&&(role==="vendedor"||role==="admin"||role==="presupuestador")&&(
            <button style={{...S.primaryBtn,background:ACCENT,color:BG,padding:"7px 12px",fontSize:13}} onClick={()=>{
          ...
          <button style={{...S.ghostBtn,fontSize:12,padding:"7px 10px"}} onClick={()=>{setRole(null);setPinRole(null);}}>Salir</button>
        </div>
      </header>
